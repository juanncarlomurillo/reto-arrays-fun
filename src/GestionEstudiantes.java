public class GestionEstudiantes {
        ...
        public static void encontrarMejorEstudiante(String[] estudiantes, double[][] notas) {
            ...
            System.out.println("\nEl estudiante con el mejor promedio es: " + mejorEstudiante + " con un promedio de " + maxPromedio);
        }
        ...
        public static void encontrarMejorMateria(String[] materias, double[][] notas) {
            ...
            System.out.println("\nLa materia con el mejor promedio es: " + mejorMateria + " con un promedio de " + maxPromedio);
        }
    }
